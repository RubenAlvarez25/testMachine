...
class QuestionControllers {
  ...
  guardarOpciones = (options, test_id) => {
    if (options != undefined) {
      options.forEach((e) => {
        let sqlOption = `INSERT INTO question_option (test_id,question_id,question_option_id,option_test_name) VALUES (${test_id},${e.question_id},${e.question_option_id},"${e.option_test_name}")`;
